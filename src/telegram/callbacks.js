...
import { sendTelegram, sendBatch, sendPositionOpen, sendTradeIntent, createTypingIndicator } from './send.js';
...
import { sendCandidate, sendPosition, closePosition, partialClosePosition, updatePositionRule, toggleTrailing } from './commands.js';
...
export async function handleCallback(query) {
  ...
  try {
    ...
    if (kind === 'sell_pct') return partialClosePosition(chatId, Number(id), Number(value), query);

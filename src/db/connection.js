...
export function initDb() {
  ...
  const defaults = {
    ...
    watch_followup_enabled: envSetting('WATCH_FOLLOWUP_ENABLED', 'true'),
    watch_followup_min_confidence: envSetting('WATCH_FOLLOWUP_MIN_CONFIDENCE', '60'),
    watch_followup_delay_ms: envSetting('WATCH_FOLLOWUP_DELAY_MS', String(7 * 60 * 1000)),
  ...
  applyStrategyDefaults({
    ...
    trench_max_single_holder_percent: 30,
  ...
  applyStrategyOverrides('degen', {
    ...
    use_llm: true,
    llm_min_confidence: 68,
    trench_blocked_routes: ['fee_trending', 'fee_graduated_trending', 'graduated_trending'],
    trench_preferred_routes: ['dual_source', 'trending'],
    trench_emergency_sl_percent: -15,
  });
